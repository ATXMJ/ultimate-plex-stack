...
1.  **Configure Plex Claim Token** [PLANNED]
...
4.  **Configure Media Libraries** [PLANNED]
    *   **Add Library - Movies:**
        *   Name: `Movies`
        *   Type: `Movies`
...
5.  **Verify Remote Access (Optional)** [PLANNED]
