...
1.  **Extend Prowlarr Configuration in `buildarr.yml`** [PLANNED][USER_INPUT]  
...
2.  **Add Radarr/Sonarr/Bazarr Sections** [PLANNED][USER_INPUT]  
...
3.  **Define Prowlarr Apps for Radarr/Sonarr** [PLANNED][USER_INPUT]  
